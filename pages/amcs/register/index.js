...
const Register = () => {
  ...
  const [userInput, setUserInput] = useState({
    ...
    mobile:"",status:'',gender:"",status:"Active", guardian:''
  });
        ...
        <form onSubmit={addUser} className={step.two? 'details-details-modal-container':'details-details-modal-container display-none'}>
          ...
          <div className='details-details-modal-body'>
            <div className='details-details-modal-body-input-box'>
                ...
                <input type="text" placeholder="Enter patient name" value={userInput.name} required onChange={e=>setUserInput(prev=>({...prev,name:e.target.value}))} />
            </div>
            <div className='details-details-modal-body-input-box'>
