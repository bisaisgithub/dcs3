        ...
        <div className='blackbg'>
            ...
            <div style={{display: 'flex', background: '#3c3f44', justifyContent: 'center'}}>
                <Link href={`/cdcs/inventory`} passHref>
                    ...
                    style={{background:'#e9115bf0', width: '20%', textAlign: 'center',
                ...
                <Link href={`/cdcs/supplier`} passHref>
                    <span 
                    onClick={()=>{setLoading(true)}}
                    style={{background:'#034c81', width: '20%', textAlign: 'center', padding: '10px', fontSize: '18px', color: 'white', fontWeight: '500'}} 
                    className='cursor-pointer'
                    >Supplier
                    </span>
                </Link>
